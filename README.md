...
Here you'll find the configuration and templates for the Cloud Service Broker documentation set published to [http://docs.pivotal.io/cloud-service-broker/](http://docs.pivotal.io/cloud-service-broker/).
...
| Branch name | Use for… |
|-------------| -------|
| master      | "edge" branch for v0.x, publishes to https://docs-pcf-staging.cfapps.io/csb-aws/1-n/index.html |
| 1.0       | v1.0.x |
